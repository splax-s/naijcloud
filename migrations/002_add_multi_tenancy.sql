...
-- Update existing edge_nodes table to include organization_id
ALTER TABLE edge_nodes 
ADD COLUMN IF NOT EXISTS organization_id UUID REFERENCES organizations(id) ON DELETE CASCADE;

-- Update existing cache_rules table to include organization_id
...
-- Update existing analytics_events table to include organization_id
...
CREATE INDEX IF NOT EXISTS idx_edge_nodes_organization_id ON edge_nodes(organization_id);
CREATE INDEX IF NOT EXISTS idx_cache_rules_organization_id ON cache_rules(organization_id);
